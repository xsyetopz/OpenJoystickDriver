...
extension DeviceManager {
  ...
  func usbDetectCurrentDevices(context: USBContext, knownLocations: Set<String>) async -> (
  ...
  @discardableResult func handleUSBDeviceAdded(_ device: USBDevice) -> DeviceIdentifier? {
