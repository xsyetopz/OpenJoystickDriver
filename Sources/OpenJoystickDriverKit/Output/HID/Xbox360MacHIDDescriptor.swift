...
///              dpad, start/menu, back/view, stick clicks, A/B/X/Y,
///              shoulders, guide, then padding; this matches the XINPUT_GAMEPAD bitmask order.
...
public enum Xbox360MacHIDDescriptor {
  ...
  private static let baseDescriptor: [UInt8] = [
    ...
    0x75, 0x08, 0x95, 0x02, 0x05, 0x01, 0x09, 0x3F, 0x09, 0x3B, 0x81, 0x01,

    // D-pad button usages first, in the macOS 360 HID byte order.
    0x75, 0x01, 0x15, 0x00, 0x25, 0x01, 0x35, 0x00, 0x45, 0x01, 0x95, 0x04, 0x05, 0x09, 0x19, 0x0C,
    0x29, 0x0F, 0x81, 0x02,

    // Menu/View and stick clicks.
    0x75, 0x01, 0x15, 0x00, 0x25, 0x01, 0x35, 0x00, 0x45, 0x01, 0x95, 0x04, 0x05, 0x09, 0x09, 0x09,
    0x09, 0x0A, 0x09, 0x07, 0x09, 0x08, 0x81, 0x02,
    ...
    // Shoulders and guide.
    0x75, 0x01, 0x15, 0x00, 0x25, 0x01, 0x35, 0x00, 0x45, 0x01, 0x95, 0x03, 0x05, 0x09, 0x09, 0x05,
    0x09, 0x06, 0x09, 0x0B, 0x81, 0x02,

    // One bit of padding.
    0x75, 0x01, 0x95, 0x01, 0x81, 0x01,

    // Analog triggers: Z, Rz.
    0x75, 0x08, 0x15, 0x00, 0x26, 0xFF, 0x00, 0x35, 0x00, 0x46, 0xFF, 0x00, 0x95, 0x02, 0x05, 0x01,
    0x09, 0x32, 0x09, 0x35, 0x81, 0x02,

    // Left stick: X/Y.
    0x75, 0x10, 0x16, 0x00, 0x80, 0x26, 0xFF, 0x7F, 0x36, 0x00, 0x80, 0x46, 0xFF, 0x7F, 0x05, 0x01,
    0x09, 0x01, 0xA1, 0x00, 0x95, 0x02, 0x05, 0x01, 0x09, 0x30, 0x09, 0x31, 0x81, 0x02, 0xC0,

    // Right stick: Rx/Ry.
    0x05, 0x01, 0x09, 0x01, 0xA1, 0x00, 0x95, 0x02, 0x05, 0x01, 0x09, 0x33, 0x09, 0x34, 0x81, 0x02,
    0xC0,

    // Xbox 360 rumble output report. SDL HIDAPI and other Xbox-style callers
    // commonly send `[0x00, 0x08, 0x00, left, right, 0, 0, 0]`.
    0x09, 0x01, 0x15, 0x00, 0x26, 0xFF, 0x00, 0x75, 0x08, 0x95, 0x08, 0x91, 0x02,
...
public struct Xbox360MacHIDReportFormat: VirtualGamepadReportFormat {
  ...
  private func xinputButtonMask(from normalized: UInt32) -> UInt16 {
    ...
    func set(_ sourceBit: Int, _ xinputBit: Int) {
      if ((normalized >> UInt32(sourceBit)) & 1) != 0 { out |= UInt16(1 << xinputBit) }
    }
