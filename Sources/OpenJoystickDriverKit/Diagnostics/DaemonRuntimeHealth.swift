...
public enum DaemonRuntimeHealthAnalyzer {
...
public enum RuntimeHealthSamplingError: LocalizedError, Sendable {
  ...
  public var errorDescription: String? {
    ...
    case .processUnavailable(let pid):
      return "Could not read runtime information for daemon process \(pid)."
    case .invalidConfiguration:
    ...
    case .noSamples:
      return "No daemon runtime samples were collected."
    }
  }
}

public enum DaemonRuntimeHealthSampler {
  ...
  public static func sample(
    ...
    guard let summary = DaemonRuntimeHealthAnalyzer.summarize(samples, policy: policy) else {
