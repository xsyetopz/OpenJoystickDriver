...
struct RemappingTransformTests {
  @Test(arguments: [
    (RemappingResponseCurve.linear, 0.5),
    (RemappingResponseCurve.easeIn, 0.25),
    (RemappingResponseCurve.easeOut, 0.75),
    (RemappingResponseCurve.smoothStep, 0.5),
  ])
  func responseCurvesAreAppliedAfterDeadzone(
    curve: RemappingResponseCurve,
    expected: Double
  ) {
