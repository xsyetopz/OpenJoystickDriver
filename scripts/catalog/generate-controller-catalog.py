...
HID_RECORDS = (
    ...
    ("hid_playstation", "USB_VENDOR_ID_SONY", "USB_DEVICE_ID_SONY_PS5_CONTROLLER_2",
     "DualSense", "dualSense", ["touchpad", "microphoneMute", "edgeButtons"]),
    ("hid_nintendo", "USB_VENDOR_ID_NINTENDO", "USB_DEVICE_ID_NINTENDO_PROCON",
     "SwitchPro", "switchPro", ["usbHandshake"]),
    ("hid_nintendo", "USB_VENDOR_ID_NINTENDO", "USB_DEVICE_ID_NINTENDO_JOYCONL",
     "SwitchPro", "switchPro", ["joyConLeft"]),
    ("hid_nintendo", "USB_VENDOR_ID_NINTENDO", "USB_DEVICE_ID_NINTENDO_JOYCONR",
     "SwitchPro", "switchPro", ["joyConRight"]),
